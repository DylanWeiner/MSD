...
public class ArrayListPQueueShuffledTiming extends TimerTemplate {

    ArrayList<Integer> list = new ArrayList<>();

    public ArrayListPQueueShuffledTiming(int[] problemSizes, int timesToLoop) {
    ...
    public static void main() throws IOException {
        ...
        var timer = new ArrayListPQueueShuffledTiming(problemSize, 10);
        var results = timer.run();

        String fileName = "ArrayListPQueueShuffledTiming.csv";
