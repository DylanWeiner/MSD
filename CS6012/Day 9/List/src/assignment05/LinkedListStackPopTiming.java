...
public class LinkedListStackPopTiming extends TimerTemplate {
    LinkedListStack<Integer> set = new LinkedListStack<>();

    public LinkedListStackPopTiming(int[] problemSizes, int timesToLoop) {
    ...
    public static void main() throws IOException {
        ...
        var timer = new LinkedListStackPopTiming(problemSize, 10);
        var results = timer.run();

        String fileName = "LinkedListStackPop.csv";
