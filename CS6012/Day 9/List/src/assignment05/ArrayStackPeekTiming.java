...
public class ArrayStackPeekTiming extends TimerTemplate {
    ArrayStack<Integer> set = new ArrayStack<>();

    public ArrayStackPeekTiming(int[] problemSizes, int timesToLoop) {
    ...
    public static void main() throws IOException {
        ...
        var timer = new ArrayStackPeekTiming(problemSize, 10);
        var results = timer.run();

        String fileName = "ArrayStackPeek.csv";
