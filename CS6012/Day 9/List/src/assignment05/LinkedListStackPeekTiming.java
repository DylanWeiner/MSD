...
public class LinkedListStackPeekTiming extends TimerTemplate {
    LinkedListStack<Integer> set = new LinkedListStack<>();

    public LinkedListStackPeekTiming(int[] problemSizes, int timesToLoop) {
    ...
    public static void main() throws IOException {
        ...
        var timer = new LinkedListStackPeekTiming(problemSize, 10);
        var results = timer.run();

        String fileName = "LinkedListStackPeek.csv";
