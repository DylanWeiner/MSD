...
public class OrderedBSTTiming extends TimerTemplate {
    BinarySearchTree<Integer> set = new BinarySearchTree<>();
    ArrayList<Integer> list = new ArrayList<>();

    public OrderedBSTTiming(int[] problemSizes, int timesToLoop) {
    ...
    public static void main() throws IOException {
        ...
        var timer = new OrderedBSTTiming(problemSize, 10);
        var results = timer.run();

        String fileName = "OrderedBSTTiming.csv";
