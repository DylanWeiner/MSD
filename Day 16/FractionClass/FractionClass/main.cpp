...
void TestConstructors()
{
    ...
    Fraction f3(10, 12);
    result = f3.toString();
    Test( "Basic constructor and reduce", "5/6", result );
    
    Fraction f4(-10, 4);
    result = f4.toString();
    Test( "Negative constructor and reduce", "-5/2", result );
    
    Fraction f5(22, -11);
    result = f5.toString();
    Test( "Negative denominator and reduce", "-2/1", result );
...
void TestNegative()
{
    ...
    Fraction f5(40, 56);
    result = f5.toString();
    Test( "Positive value and reduce", "5/7", result );
    
    Fraction f6(-20, -40);
    result = f6.toString();
    Test( "Negative numerator and denominator and reduce", "1/2", result );
    
    Fraction f7(-16, 16);
    result = f7.toString();
    Test( "Negative numerator and reduce", "-1/1", result );
}
...
void TestReduced()
{
    ...
    Fraction f2(-8, 4);
    result = f2.toString();
    Test( "Reduce fraction (-8/4)", "-2/1", result );
    
    result = "";
    Fraction f3(18, -72);
    result = f3.toString();
    Test( "Reduce fraction (-18/72)", "-1/4", result );
}
...
void TestReciprocal()
{
    ...
    f4 = f4.reciprocal();
    result = f4.toString();
    Test( "Reciprocal of negative non-reduced", "-1/3", result );
    
    Fraction f5(128, -256);
    f5 = f5.reciprocal();
    result = f5.toString();
    Test( "Reciprocal of negative non-reduced", "-2/1", result );
}
...
void TestPlus()
{
    ...
    Fraction f5 = f4.plus(f1);
    result = f5.toString();
    Test( "Addition of non-reduced", "11/3", result );
    
    Fraction f6 = f4.plus(f2);
    result = f6.toString();
    Test( "Addition of non-reduced", "15/4", result );
    
    Fraction f7 = f4.plus(f3);
    result = f7.toString();
    Test( "Addition of non-reduced", "53/12", result );
}
