...
// FUNCTION generate_let_expression(depth):
...
//     generate_rand_let ← random integer between 0 and 4 (inclusive)

//     IF generate_rand_let < 4 THEN

//         IF generate_rand_let is even THEN
//             rhs ← generate_add()
//         ELSE
//             rhs ← generate_mult()
//         ENDIF

//         IF generate_rand_let is divisible by 3 THEN
//             body ← s + "+" + generate_add()
//         ELSE
//             body ← s + "*" + generate_mult()
//         ENDIF

//     ELSE
//         rhs ← generate_number()
//         body ← generate_let_expression(2)
//     ENDIF

//     expression ← "_let" + " " + s + " = " + rhs + " _in " + body
